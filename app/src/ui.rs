...
impl Icon {
    pub fn path(self) -> &'static str {
        match self {
            ...
            Icon::CircleEllipsis => "icons/circle-ellipsis.svg",
            ...
            Icon::ChevronsDownUp => "icons/chevrons-down-up.svg",
            Icon::ChevronsUpDown => "icons/chevrons-up-down.svg",
            Icon::ChevronsRight => "icons/chevrons-right.svg",
...
impl AssetSource for Assets {
    fn load(&self, path: &str) -> Result<Option<std::borrow::Cow<'static, [u8]>>> {
        let bytes: &'static [u8] = match path {
            ...
            "icons/circle-ellipsis.svg" => include_bytes!("../assets/icons/circle-ellipsis.svg"),
            ...
            "icons/chevrons-down-up.svg" => include_bytes!("../assets/icons/chevrons-down-up.svg"),
            "icons/chevrons-up-down.svg" => include_bytes!("../assets/icons/chevrons-up-down.svg"),
            "icons/chevrons-right.svg" => include_bytes!("../assets/icons/chevrons-right.svg"),
